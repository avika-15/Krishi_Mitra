const dict = {
  hi: {
    ...
    other: "अन्य",
    // RegisterPoor
    registerPoor: "पीएम किसान सम्मान निधि योजना",
    poorDesc: "पीएम किसान सम्मान निधि योजना के लिए पंजीकरण",
    poorHeading: "पीएम किसान सम्मान निधि योजना के लिए पंजीकरण",
    poorSub: "योग्य किसानों के लिए वित्तीय सहायता कार्यक्रम",
    ...
    calendarSpringTip1: "अधिकांश वसंत बुवाई के लिए मिट्टी का तापमान 10°C होने की प्रतीक्ा करें",
  ...
  en: {
    ...
    poorDesc: "Registration for PM Kisan Samman Nidhi Yojna",
    poorHeading: "PM Kisan Samman Nidhi Yojna Registration",
    poorSub: "Financial assistance program for eligible farmers",
    idNumber: "ID Number",
    ...
    copyright: "&copy; 2025 कृषि मित्र. All rights reserved.",
    // Calendar
